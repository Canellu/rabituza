    ...
    <div>
      <Button
        ...
        className={cn(
          ...
          calendarOpen && 'bg-stone-50 dark:bg-stone-950'
        )}
      ...
      <AnimateHeight isOpen={calendarOpen} marginBottom={16}>
        <div className="border bg-stone-50 rounded-md p-4 space-y-4 dark:bg-stone-900 dark:border-transparent">
          <Calendar
            mode="single"
            weekStartsOn={1}
            selected={date}
            ...
            className="items-center flex w-full justify-center rounded-md border bg-white dark:bg-stone-900 dark:border-stone-800"
          />
