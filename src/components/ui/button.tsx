  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-input bg-background sm:hover:bg-accent sm:hover:text-accent-foreground dark:bg-stone-900',
        secondary:
          'bg-secondary dark:bg-stone-950 border text-secondary-foreground sm:hover:bg-secondary/80 dark:border-transparent',
        ghost: 'sm:hover:bg-accent sm:hover:text-accent-foreground',
        link: 'text-primary underline-offset-4 sm:hover:underline',
      },
      size: {
        default: 'h-10 px-4 py-2',
        sm: 'h-9 rounded-md px-3 text-sm px-4 py-2',
        lg: 'h-11 rounded-md px-8 px-4 py-2 text-lg',
        icon: 'h-10 w-10',
      },
    },
    defaultVariants: {
